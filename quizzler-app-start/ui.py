...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score = Label(text="Score: 0", font= ("Courier"), fg="white", highlightthickness=0, bg=THEME_COLOR)
        self.score.grid(row=0, column=1)

        self.canvas = Canvas(width=300, height=250, bg="White")
        self.question_text = self.canvas.create_text(150, 120, text="Questions", width=280, font=("Arial", 15, "italic"), fill=THEME_COLOR)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text="Congratulations You have completed the Quiz!.")
